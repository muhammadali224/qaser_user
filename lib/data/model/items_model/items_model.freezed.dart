...
abstract class _ItemModel implements ItemModel {
  const factory _ItemModel(
      ...
      @JsonKey(name: "images") final List<String>? images,
      @JsonKey(name: "item_count") final int? itemCount}) = _$ItemModelImpl;
